...
public class FacturaPdfView extends AbstractPdfView {
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		// TENEMOS 2 FORMAS, CON EL LOCALE O CON EL MessageSourceAccessor
		Locale locale = localeResolver.resolveLocale(request);

		// OTRA FORMA DE USAR EL LOCALE SIN USAR EL MESSAGESOURCE Y NO NECESITARIAMOS NADA MAS
		// VIENE DEL ApplicationObjectSupport
